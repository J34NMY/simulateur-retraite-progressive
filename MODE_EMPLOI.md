...
1. Téléchargez le fichier HTML correspondant à votre situation réglementaire
2. Double-cliquez pour l'ouvrir dans votre navigateur — aucune installation requise
3. Munissez-vous de votre **Relevé Individuel de Situation (RIS)** disponible sur [info-retraite.fr](https://www.info-retraite.fr)
4. Remplissez l'onglet **Paramètres** puis cliquez sur **"Calculer la simulation"**
...
⚠️ Les valeurs qui s'affiche a l'ouverture sont des valeurs d'exemples a modifier selon vos données
...
## 2️⃣ Onglet Résultats RP

Après calcul, cet onglet affiche :
...
> 💡 **Cas particulier :** Si vous avez travaillé à 80% en début de carrière et souhaitez reprendre à 100%, saisissez 100% dans le champ quotité future. Le simulateur calculera la pension définitive avec des liquidables à 100% sur la période future.
...
### Logique de la comparaison avec un placement

Le simulateur calcule la comparaison en **2 phases** :
- **Phase 1** : vous placez le montant mensuel équivalent pendant la durée de surcotisation/rachat
- **Phase 2** : ce capital fructifie jusqu'à votre départ en retraite
- **À la retraite** : le revenu mensuel = intérêts annuels du capital final / 12

> Le capital du placement reste disponible et transmissible. Le supplément de pension, lui, est versé à vie mais le capital est perdu.
