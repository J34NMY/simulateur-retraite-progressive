# 📖 Mode d'emploi du Simulateur de Retraite Progressive V.04.2.6
...
**✨ NOUVEAU V.04.2.6 :** Exports PDF professionnels avec support natif des accents français par jsPDF 2.5.1 pour une lisibilité universelle.
...
3. Un fichier JSON est téléchargé : `parametres_simulateur_retraite_v04_2_6.json`
...
**Phase de validation en cours** (V.04.2.6)
...
**Important V.04.2.5 (toujours d'actualité en V.04.2.6) :**
...
- Téléchargez la version V.04.2.5 ou V.04.2.6 avec les coefficients corrects
...
- Téléchargez la version V.04.2.6 pour bénéficier du support natif des accents
...
- ✅ Support natif des accents français par jsPDF 2.5.1 (plus de conversion nécessaire)
...
**Version du mode d'emploi :** V.04.2.6 - Octobre 2025

**Dernière mise à jour :** Support natif accents PDF (jsPDF 2.5.1) + avertissements renforcés
